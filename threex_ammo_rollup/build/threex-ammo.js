(function (global, factory) {
        ...
        (factory((global.THREEx = global.THREEx || {})));
}(this, (function (exports) { 'use strict';

var AmmoControls = function(object3d, options){
        options = options || {};
        ...
        if( options.shape !== undefined ){
                ...
                var shape = AmmoControls.guessShapeFromObject3d(object3d);
        }

        if( options.mass !== undefined ){
                var mass = options.mass;
        }else{
                var mass = AmmoControls.guessMassFromObject3d(object3d);
        }
...
AmmoControls.guessMassFromObject3d = function(object3d){
...
AmmoControls.guessShapeFromObject3d = function(object3d){
        if( object3d.geometry instanceof THREE.BoxGeometry ){
...
AmmoControls.prototype.setRestitution = function(value){
        this.physicsBody.setRestitution( value );
};

AmmoControls.prototype.setAngularVelocity = function(x,y,z){
...
AmmoControls.prototype.setLinearVelocity = function(x,y,z){
        var btVector3 = new Ammo.btVector3( x, y, z );
...
exports.AmmoControls = AmmoControls;
